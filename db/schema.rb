...
ActiveRecord::Schema.define(version: 20171120155507) do

  create_table "account_hashes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "hashcode"
    t.bigint "user_id"
  ...
  create_table "message_contacts", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.text "message"
    t.string "name"
    t.string "email"
    t.string "phone"
